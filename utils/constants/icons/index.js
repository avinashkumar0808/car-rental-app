...
export const cameraFlipIcon = `<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.9999 0C1.1135 0 0.399902 0.7136 0.399902 1.6V14.4C0.399902 15.2864 1.1135 16 1.9999 16H17.9999C18.8863 16 19.5999 15.2864 19.5999 14.4V1.6C19.5999 0.7136 18.8863 0 17.9999 0H1.9999ZM9.9999 2.90313C12.8079 2.90313 15.0968 5.192 15.0968 8H16.7999L14.5327 10.8328L12.2671 8H13.964C13.964 5.8045 12.1954 4.03594 9.9999 4.03594C9.53276 4.03594 9.08729 4.12003 8.67178 4.26719L7.80928 3.40625C8.47411 3.08757 9.21543 2.90313 9.9999 2.90313ZM5.46709 5.16719L7.73272 8H6.03584C6.03584 10.1955 7.8044 11.9641 9.9999 11.9641C10.467 11.9641 10.9125 11.88 11.328 11.7328L12.1905 12.5938C11.5257 12.9124 10.7844 13.0969 9.9999 13.0969C7.1919 13.0969 4.90303 10.808 4.90303 8H3.1999L5.46709 5.16719Z" fill="white"/>
</svg>
`;

export const torchOn = `<svg width="15" height="21" viewBox="0 0 15 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.22503 7L12.25 0H4.27803L0.978027 11H6.33703L3.88503 19.648L4.63503 20.012L14.374 7H7.22503ZM7.66303 10H2.32203L5.02203 1H10.3L5.27503 8H12.376L5.67603 16.953L7.66303 10Z" fill="white"/>
</svg>
`;
export const torchOff = `<svg width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.516 13.158L11.23 13.872L6.63497 20.012L5.88497 19.648L8.33697 11H2.97797L4.21997 6.861L5.02297 7.664L4.32197 10H7.35797L9.15097 11.792L7.67597 16.952L10.516 13.158ZM16.5 17.208L0.792969 1.5L1.49997 0.793L4.99197 4.285L6.27797 0H14.25L9.22497 7H16.374L12.664 11.957L17.207 16.5L16.5 17.208ZM8.70697 8L11.95 11.243L14.376 8H8.70697ZM5.79497 5.088L7.87397 7.167L12.3 1H7.02197L5.79497 5.088Z" fill="white"/>
</svg>
`;

export const calendar = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16 13.0011L8 13M7 3V5M17 3V5M6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#ABB3C7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`;

export const starWithoutColor = ``;

export const starWithColor = `<svg viewBox="0 -0.03 60.062 60.062" xmlns="http://www.w3.org/2000/svg" fill="#FFBD14" stroke="#FFBD14"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><defs><style> .cls-1 { fill: #FFBD14; fill-rule: evenodd; } </style></defs><path class="cls-1" d="M670.68,227.733a3.03,3.03,0,0,0,.884,1.072,3.168,3.168,0,0,0,1.282.578l14.662,2.965a3.067,3.067,0,0,1,2.394,2.284,3,3,0,0,1-1.118,3.084l-11.408,8.654a3.01,3.01,0,0,0-.994,1.3,2.956,2.956,0,0,0-.16,1.618L679.3,266.42a3,3,0,0,1-1.275,3.01,3.166,3.166,0,0,1-3.328.146l-13.18-7.407a3.165,3.165,0,0,0-3.091,0l-13.181,7.407a3.156,3.156,0,0,1-3.327-.146,3,3,0,0,1-1.275-3.01l3.078-17.129a2.956,2.956,0,0,0-.16-1.618,3.01,3.01,0,0,0-.994-1.3l-11.408-8.654a3,3,0,0,1-1.118-3.084,3.068,3.068,0,0,1,2.393-2.284l14.66-2.965a3.141,3.141,0,0,0,1.281-.578,3.044,3.044,0,0,0,.885-1.072l7.918-16.013a3.133,3.133,0,0,1,5.587,0Z" id="rating" transform="translate(-629.938 -210)"></path></g></svg>`;
